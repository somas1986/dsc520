...
housing<-read_excel("/Users/somashekarvayuvegula/Documents/Workspace/dsc520/completed/week4/week-6-housing.xlsx")
head(housing)
...
salePrice <- as.integer('Sale Price')
x <- ddply(housing.dat, c("'sale year'", "ctyname"), summarize, homeruns = sum(salePrice))
head(x)
...
hist(housing$`Sale Price`,xlab = "Price",main = "Histogram of Price") 

...
#Read data from CSV
data<-read.csv("/Users/somashekarvayuvegula/Documents/Workspace/dsc520/completed/week4/scores.csv")

# What are the observational units in this study?
#Answer - comparing students performance in the two sections using course grades and total points earned in the course
